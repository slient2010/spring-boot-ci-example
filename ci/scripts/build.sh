...
cp -a build/libs/*.jar spring-boot-ci-example
cat << EOF > Dockerfile
...
ADD spring-boot-ci-example/spring-boot-ci-example-0.0.1-SNAPSHOT.jar /spring-boot-ci-example-0.0.1-SNAPSHOT.jar
